...
namespace ClientApp.Forms
{
    public partial class MainForm : Form
    {
        ...
        public MainForm(Client client)
        {
            ...
            _client = client;
            _client.GetInfoFromServer(mainDataGridView, cmbTables, lstTables, lblText);
        ...
        private void lstQuaries_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (lstQuaries.SelectedIndex)
            {
                case 0:
                ...
                default:
                    MessageBox.Show(@"Unexpected quary!.", @"Error!", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
            }
        }
    }
